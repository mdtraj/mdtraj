...
:code:`path-to-mdtraj/examples`. The notebook files for these examples and the notebooks are available in the top level  `examples folder <https://github.com/rmcgibbo/mdtraj/tree/master/examples>`_ on github too. In the directory with the notebook
