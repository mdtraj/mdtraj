...
project = u'MDTraj'
copyright = u'2014, Robert McGibbon and contributors'
...
release = mdtraj.version.short_version
...
latex_documents = [
  ('index', 'MDTraj.tex', u'MDTraj Documentation',
...
texinfo_documents = [
  ('index', 'MDTraj', u'MDTraj Documentation',
   u'Robert McGibbon', 'MDTraj', 'One line description of project.',
   'Miscellaneous'),
]
